...
## [Type Traits](http://www.drdobbs.com/cpp/c-type-traits/184404270)

- so far we have looked at various ways of using templates
- sometimes the differences between types are too great for an efficient generic implementation
- being able to do compile time introspection can be very useful and C++ 11 (and before that boost) gives us a [traits library](http://en.cppreference.com/w/cpp/types)
> Think of a trait as a small object whose main purpose is to carry information used by another object or algorithm to determine "policy" or "implementation details". - Bjarne Stroustrup 


--

## [is_void](http://en.cppreference.com/w/cpp/types/is_void)
- creating trait classes is tedious but simple 
...
## [Selection](https://accu.org/index.php/journals/442)
...
## [std::static_assert](http://en.cppreference.com/w/cpp/language/static_assert)
- this allows us to do compile time checking
- it can be combined with traits and other classes to check that library functions / code can be used
- the following example generates an array based on certain types

--

## [UArray.h](https://github.com/NCCA/Templates/blob/master/types/UArray.h)
...
## [main.cpp](https://github.com/NCCA/Templates/blob/master/types/main.cpp)
...
<iframe width="1000px" height="400px" src="https://godbolt.org/e#g:!((g:!((g:!((h:codeEditor,i:(j:2,lang:c%2B%2B,source:'%23include+%3Carray%3E%0A%23include+%3Climits%3E%0A%23include+%3Cmemory%3E%0A%23include+%3Ciostream%3E%0A%0Atemplate+%3Ctypename+Type%3E%0Aclass+Array%0A%7B%0A++public+:%0A++%09static_assert(std::is_unsigned%3CType%3E::value,%22Can+Only+use+Unsigned+types%22)%3B%0A++%09static_assert(std::numeric_limits%3CType%3E::max()+%3C%3D+std::numeric_limits%3Cunsigned+int%3E::max()%0A++%09%09,%22Can+Only+use+sizes+up+to+unsigned+int!!%22)%3B%0A++%09%0A++%09Array()%0A++%09%7B%0A++%09%09//+grab+the+size+of+the+data+and+add+1.%0A++%09%09m_size%3Dstatic_cast%3Cunsigned++long+long%3E(std::numeric_limits%3CType%3E::max())%2B1%3B%0A++%09%09//+allocate+memory%0A++%09%09m_data.reset(new+Type%5Bm_size%5D)%3B%0A++%09%7D%0A++%09unsigned+long+long+size()%7B+return+m_size%3B%7D%0A%0A++private+:%0A++%09//+have+to+use+heap+allocation+as+stack+will+be+too+small+so%0A++%09//+can!'t+use+std::array%0A++%09std::unique_ptr%3CType+%5B%5D%3E+m_data%3B%0A++%09//+the+size+of+the+unit+is+4294967296+the+largest+we+can+hold!!%09%0A++%09unsigned+long+long+m_size%3B%0A%7D%3B%0A%0Aint+main()%0A%7B%0A%09Array%3Cunsigned+char%3E+uarray%3B%0A%09uarray.size()%3B%0A%0A%09Array%3Cunsigned+short%3E+usrray%3B%0A%09usrray.size()%3B%0A%0A%09Array%3Cunsigned+int%3E+uiarray%3B%0A%09uiarray.size()%3B%0A%7D'),l:'5',n:'0',o:'C%2B%2B+source+%232',t:'0')),header:(),k:57.42148995997847,l:'4',m:100,n:'0',o:'',s:0,t:'0'),(g:!((h:compiler,i:(compiler:g72,filters:(b:'0',binary:'1',commentOnly:'0',demangle:'0',directives:'0',execute:'1',intel:'0',trim:'0'),lang:c%2B%2B,libs:!(),options:'',source:2),l:'5',n:'0',o:'x86-64+gcc+7.2+(Editor+%232,+Compiler+%231)+C%2B%2B',t:'0')),header:(),k:42.578510040021534,l:'4',n:'0',o:'',s:0,t:'0')),l:'2',n:'0',o:'',t:'0')),version:4"></iframe>
...
- These were introduced in c++ 14 and defines a family of variables or static data members
...
<iframe width="1000px" height="400px" src="https://godbolt.org/e#g:!((g:!((g:!((h:codeEditor,i:(j:2,lang:c%2B%2B,source:'%23include+%3Ciostream%3E%0A%23include+%3Ciomanip%3E%0A%23include+%3Climits%3E%0Atemplate%3Ctypename+T%3E+constexpr+T+pi+%3D+T(3.141592653589793238462643383L)%3B%0A%0Atemplate%3C%3E%0Aconstexpr+const+char*+pi%3Cconst+char*%3E+%3D+%22pi%22%3B%0A%0Aint+main()%0A%7B%0A++std::cout.precision(std::numeric_limits%3Clong+double%3E::digits10)%3B%0A++std::cout+%3C%3C+pi%3Cchar%3E%3C%3C!'%5Cn!'%3B%0A++std::cout+%3C%3C+pi%3Cint%3E%3C%3C!'%5Cn!'%3B%0A++std::cout+%3C%3C+pi%3Cfloat%3E%3C%3C!'%5Cn!'%3B%0A++std::cout+%3C%3C+pi%3Cdouble%3E%3C%3C!'%5Cn!'%3B%0A++std::cout+%3C%3C+pi%3Clong+double%3E%3C%3C!'%5Cn!'%3B%0A++std::cout+%3C%3C+pi%3Cconst+char+*%3E+%3C%3C!'%5Cn!'%3B%0A%7D'),l:'5',n:'0',o:'C%2B%2B+source+%232',t:'0')),header:(),k:57.42148995997847,l:'4',m:100,n:'0',o:'',s:0,t:'0'),(g:!((h:compiler,i:(compiler:g72,filters:(b:'0',binary:'1',commentOnly:'0',demangle:'0',directives:'0',execute:'1',intel:'0',trim:'0'),lang:c%2B%2B,libs:!(),options:'',source:2),l:'5',n:'0',o:'x86-64+gcc+7.2+(Editor+%232,+Compiler+%231)+C%2B%2B',t:'0')),header:(),k:42.578510040021534,l:'4',n:'0',o:'',s:0,t:'0')),l:'2',n:'0',o:'',t:'0')),version:4"></iframe>
...
- One of the main issues with templates are the error messages generated
- They can be really complex to decode and parse
- C++ has a TS in the pipeline know as ["concepts"](http://en.cppreference.com/w/cpp/language/constraints) which (should) appear in C++ 20
- This will make reading errors from templates a lot better

--

## Concepts

- The definition of a concept has the form of 
	- a function template definition (function concept) 
	- variable template definition (variable concept). 
...
- [Concepts Lite vs enable_if](https://akrzemi1.wordpress.com/2016/09/21/concepts-lite-vs-enable_if/)
- [Background on Concepts](https://isocpp.org/blog/2016/02/a-bit-of-background-for-concepts-and-cpp17-bjarne-stroustrup)
